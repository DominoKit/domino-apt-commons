...
public class FullNameTest {
  ...
  public void gettingImportFromClassFullNameWithSingleGeneric() throws Exception {
    assertEquals(
        "aaa.bbb.ccc.Test", new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A>").asImport());
  ...
  public void gettingSimpleGenericClassNameFromClassFullNameWithSingleGeneric() throws Exception {
    assertEquals(
        "Test<A>", new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A>").asSimpleGenericName());
  ...
  public void gettingAllImportsFromClassFullNameWithSingleGeneric() throws Exception {
    ...
    assertEquals(
        expected_1,
        importsAsOneString(new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A>").allImports()));

    String expected_2 = "aaa.bbb.ccc.Test\n" + "A\n";
    assertEquals(
        expected_2, importsAsOneString(new FullClassName("aaa.bbb.ccc.Test<A>").allImports()));

    String expected_3 = "Test\n" + "ddd.eee.fff.A\n";
    assertEquals(
        expected_3, importsAsOneString(new FullClassName("Test<ddd.eee.fff.A>").allImports()));
  ...
  public void gettingSimpleClassNameFromClassFullNameWithMultiGeneric() throws Exception {
    assertEquals(
        "Test", new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A,ggg.hhh.iii.B>").asSimpleName());
  ...
  public void gettingPackageFromClassFullNameWithMultiGeneric() throws Exception {
    assertEquals(
        "aaa.bbb.ccc",
        new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A,ggg.hhh.iii.B>").asPackage());
  ...
  public void gettingImportFromClassFullNameWithMultiGeneric() throws Exception {
    assertEquals(
        "aaa.bbb.ccc.Test",
        new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A,ggg.hhh.iii.B>").asImport());
  ...
  public void gettingSimpleGenericClassNameFromClassFullNameWithMultiGeneric() throws Exception {
    assertEquals(
        "Test<A,B>",
        new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A,ggg.hhh.iii.B>").asSimpleGenericName());
    assertEquals(
        "Test<A,B>", new FullClassName("Test<ddd.eee.fff.A,ggg.hhh.iii.B>").asSimpleGenericName());
  ...
  public void gettingAllImportsFromClassFullNameWithMultiGeneric() throws Exception {
    ...
    assertEquals(
        expected_1,
        importsAsOneString(
            new FullClassName("aaa.bbb.ccc.Test<ddd.eee.fff.A,ggg.hhh.iii.B>").allImports()));

    String expected_2 = "aaa.bbb.ccc.Test\n" + "A\n" + "B\n";
    assertEquals(
        expected_2, importsAsOneString(new FullClassName("aaa.bbb.ccc.Test<A,B>").allImports()));

    String expected_3 = "Test\n" + "ddd.eee.fff.A\n" + "ggg.hhh.iii.B\n";
    assertEquals(
        expected_3,
        importsAsOneString(new FullClassName("Test<ddd.eee.fff.A,ggg.hhh.iii.B>").allImports()));
    ...
    assertEquals(
        expected_3,
        importsAsOneString(
            new FullClassName("Test<ddd.eee.fff.A,ggg.hhh.iii.B,ggg.hhh.iii.B>").allImports()));
  }
